...
;; TEST
(define newlib-nano-arm-none-eabi-12.3.rel1
  (package
    (inherit (make-newlib-nano-arm-none-eabi-12.3.rel1))
    (arguments
      (package-arguments (make-newlib-nano-arm-none-eabi)))))
;; Need to remake the toolchain package to include the fix above.
(define arm-none-eabi-nano-toolchain-12.3.rel1
  ((@@ (gnu packages embedded) make-arm-none-eabi-toolchain)
    ...
    newlib-nano-arm-none-eabi-12.3.rel1))
(define qmk-arm-none-eabi-nano-toolchain-12.3.rel1
  (qmk-wrap-toolchain "arm-none-eabi-nano-toolchain-12.3.rel1"
...
(packages->manifest
  (list
    ...
    qmk-arm-none-eabi-nano-toolchain-12.3.rel1
    qmk-avr-toolchain
